...
#+ 2.5: Slide 3 — EMS-to-TI timing with vascular injury overlay
u()
p_timing <- plot_timing_vascular(test_dedup, for_slides = TRUE)
print_to_png(p_timing, "slide3_timing_vascular", width = 10, height = 5, output_dir = out_dir)
